    ...
    <div className="shadow-lg lg:mx-16 mx-2 lg:p-12 p-4 rounded-xl">
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl font-extrabold text-gray-800 dark:text-[#C8A26B] mb-6">Contact Us</h2>
            <ContactForm />
          </div>
          <div className="hidden md:block">
            ...
            <div>
              ...
              <p className="text-xl text-gray-800 dark:text-[#C8A26B] font-bold">+91 9998883332</p>
            </div>
          </div>
        </div>
