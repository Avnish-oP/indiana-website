      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-8 md:mb-0 md:w-1/3 text-center md:text-left">
            ...
            <h2 className="text-3xl font-bold mb-4 gilda-display-regular">Indiana Merchandise</h2>
            <p className="text-lg">
              Providing the best quality products with exceptional service.
            </p>
          </div>
          <div className="mb-8 md:mb-0 md:w-1/3 text-center">
            <h3 className="text-2xl font-bold mb-4 gilda-display-regular">Contact Us</h3>
            <p>
          ...
          <div className="md:w-1/3 text-center md:text-right">
            <h3 className="text-2xl font-bold mb-4 gilda-display-regular">Follow Us</h3>
